...
```php
function ordersCreate(array $options): Order
```
...
$result = $ordersController->ordersCreate($collect);
```
...
```php
function ordersGet(array $options): Order
```
...
$result = $ordersController->ordersGet($collect);
```
...
```php
function ordersPatch(array $options): void
```
...
$ordersController->ordersPatch($collect);
```
...
```php
function ordersConfirm(array $options): Order
```
...
$result = $ordersController->ordersConfirm($collect);
```
...
```php
function ordersAuthorize(array $options): OrderAuthorizeResponse
```
...
$result = $ordersController->ordersAuthorize($collect);
```
...
```php
function ordersCapture(array $options): Order
```
...
$result = $ordersController->ordersCapture($collect);
```
...
```php
function ordersTrackCreate(array $options): Order
```
...
$result = $ordersController->ordersTrackCreate($collect);
```
...
```php
function ordersTrackersPatch(array $options): void
```
...
$ordersController->ordersTrackersPatch($collect);
```
