...
| `ordinal` | `?int` | Optional | Ordinal number for sorting.<br><br>**Constraints**: `>= 1`, `<= 99` | getOrdinal(): ?int | setOrdinal(?int ordinal): void |
...
| `status` | `?string` | Optional | The status of the payment token.<br><br>**Default**: `'CREATED'`<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[0-9A-Z_]+$` | getStatus(): ?string | setStatus(?string status): void |
