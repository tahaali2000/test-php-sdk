...
class PaymentsController extends BaseController
{
     ...
     */
    public function authorizationsGet(string $authorizationId): PaymentAuthorization
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function authorizationsCapture(array $options): CapturedPayment
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function authorizationsReauthorize(array $options): PaymentAuthorization
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
     ...
     * @param array $options Array with all options for search
     *
     * @return PaymentAuthorization|null Response from the API call
     *
     * @throws ApiException Thrown if API call fails
     */
    public function authorizationsVoid(array $options): ?PaymentAuthorization
    {
        $_reqBuilder = $this->requestBuilder(
            RequestMethod::POST,
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function capturesGet(string $captureId): CapturedPayment
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function capturesRefund(array $options): Refund
    {
     ...
     * @throws ApiException Thrown if API call fails
     */
    public function refundsGet(string $refundId): Refund
    {
